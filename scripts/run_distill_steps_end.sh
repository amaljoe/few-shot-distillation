...
echo "================================================================"
echo " Distillation timing ablation (END variant)"
echo " Model      : Qwen/Qwen3-1.7B"
echo " Conditions : final N steps distilled, N in {0, 4, 16, 64, 200}"
...
for STEPS in 0 4 16 64 200; do
    ...
    echo ">>> Training: distill steps ${DISTILL_START}–199  (last ${STEPS} steps)  on GPUs 0-3 …"
    CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch \
        --num_processes 4 --mixed_precision bf16 --main_process_port 29500 \
        scripts/distill_steps_end_experiment.py --distill_steps ${STEPS}
    echo ""
...
echo "   experiments/distill_steps_end/eval_results.json"
echo "   experiments/distill_steps_end/distill_steps_end_accuracy.png"
echo "================================================================"
